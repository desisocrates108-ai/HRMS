...
async def seed():
    ...
    jobs = [
        ...
        {"id": uid(), "role": "Franchise Manager", "type": "branch", "branch_id": branch_ids[3], "location": "Chennai, Anna Nagar", "salary_range_min": 40000, "salary_range_max": 60000, "status": "open", "description": "Franchise manager for Chennai operations", "created_by": admin_id, "created_at": now_iso(20)},
